...
- [ ] **Step 2: Run the focused tests and observe join-only export failure**
...
- [ ] **Step 3: Implement classified exports**
...
- [ ] **Step 5: Run the complete followers suite**
...
- [ ] **Step 2: Run focused TikPoc tests and observe failure**
...
- [ ] **Step 5: Commit the tracked TikPoc implementation**
...
- [ ] **Step 1: Document A/B/C and metadata**
...
- [ ] **Step 2: Export a fixture from a temporary collector database**
...
- [ ] **Step 5: Record the external collector checksum and push**
